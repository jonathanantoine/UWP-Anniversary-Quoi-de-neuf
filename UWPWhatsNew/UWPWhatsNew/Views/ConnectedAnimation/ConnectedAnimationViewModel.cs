...
namespace UWPWhatsNew.Views.ConnectedAnimation
{
    public class ConnectedAnimationViewModel : BindableBase
    {
        public ConnectedAnimationViewModel()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                Items.Add(new Thumbnail("Surface Pro 4", PREFIX_URL + "s1.jpg"+"?ee="+i, "Un chat tout mignon"));
                Items.Add(new Thumbnail("Chat 1", PREFIX_URL + "u1.png" + "?ee=" +i, "Un chat tout mignon"));
                Items.Add(new Thumbnail("Surface Book", PREFIX_URL + "s2.jpg" + "?ee=" +i, "Un chat tout mignon"));
                Items.Add(new Thumbnail("Chat 2", PREFIX_URL + "u2.jpg" + "?ee=" +i, "Un chat tout mignon"));
                Items.Add(new Thumbnail("Hololens", PREFIX_URL + "s3.png" + "?ee=" +i, "Un chat tout mignon"));
                Items.Add(new Thumbnail("Chat 3", PREFIX_URL + "u3.png" + "?ee=" +i, "Un chat tout mignon"));
                Items.Add(new Thumbnail("MS Band", PREFIX_URL + "s4.png" + "?ee=" +i, "Un chat tout mignon"));
                Items.Add(new Thumbnail("Xbox One", PREFIX_URL + "s5.png" + "?ee=" +i, "Un chat tout mignon"));
            }
